...
**Description:**
`XZe is a tool written in rust that uses open source models from ollama to analyze a services source code and doc in the service git repository and creates documentation for the project.`
