...
- `docs/explanation/phase2_semantic_chunking_similarity_embeddings_implementation.md` (this document)
...
- Phase 1: `docs/explanation/phase1_semantic_chunking_core_types_implementation.md`
