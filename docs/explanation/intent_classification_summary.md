...
**File**: `docs/explanation/intent_classification_design.md`
...
**File**: `docs/explanation/intent_classification_implementation_plan.md`
...
- **Design Document**: `docs/explanation/intent_classification_design.md`
