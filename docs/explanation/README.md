...
This directory contains understanding-oriented documentation that clarifies and illuminates particular topics in the XZe project. Explanation documents are about understanding concepts, design decisions, and the "why" behind the system.

## What is Explanation?

According to the Diátaxis framework, explanation is:
...
Explanation is best read when you want to:
