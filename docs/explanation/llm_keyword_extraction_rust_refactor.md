...
- **Proper documentation structure**: File placed in `docs/explanation/`
...
- Implementation plan in `docs/explanation/`
...
- `docs/explanation/implement_llm_keyword_extraction.md` - Main implementation plan
