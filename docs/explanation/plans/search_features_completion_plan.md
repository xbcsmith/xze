...
- `docs/explanation/api_versioning_strategy.md` (200+ lines)
...
- `docs/explanation/embedding_cache.md` (200+ lines)
...
- `docs/explanation/search_quality.md` (200+ lines)
...
- [ ] `docs/explanation/api_versioning_strategy.md` - Versioning approach and rationale
