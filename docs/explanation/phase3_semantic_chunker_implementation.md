...
- `docs/explanation/phase3_semantic_chunker_implementation.md` (this file)
...
- Phase 1 Implementation: `docs/explanation/phase1_semantic_chunking_core_types_implementation.md`
- Phase 2 Implementation: `docs/explanation/phase2_semantic_chunking_similarity_embeddings_implementation.md`
