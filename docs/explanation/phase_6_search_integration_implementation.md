...
- Phase 4: `docs/explanation/phase_4_database_integration.md`
- Phase 5: `docs/explanation/phase_5_integration_implementation.md`
- Semantic Chunking Plan: `docs/explanation/semantic_chunking_implementation_plan.md`
