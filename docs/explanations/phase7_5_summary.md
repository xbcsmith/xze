...
- `docs/explanations/phase7_5_api_versioning_implementation.md`
- `docs/how_to/migrate_to_api_v1.md`
- `docs/reference/api_v1_specification.md`
- `docs/explanations/phase7_5_summary.md` (this file)
...
- Implementation: `docs/explanations/phase7_5_api_versioning_implementation.md`
