...
- `docs/explanations/semantic_chunking_implementation_plan.md`: Overall design
- `docs/explanations/phase_6_search_integration_implementation.md`: Search details
- `docs/explanations/phase_7_documentation_and_testing_implementation.md`: This document
